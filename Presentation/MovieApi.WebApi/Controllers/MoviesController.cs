...
namespace MovieApi.WebApi.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMovie(CreateMovieCommand command)
        {
            ...
            return Ok("Film başarıyla platformumuza eklendi. Keşfedilmeye hazır!");
        }
        ...
        public async Task<IActionResult> DeleteMovie(int id)
        {
            ...
            return Ok("Film arşivden kaldırıldı. Artık keşif listemizde yer almıyor.");
        }
        ...
        public async Task<IActionResult> UpdateMovie(UpdateMovieCommand command)
        {
            ...
            return Ok("Film bilgileri güncellendi. Yeni detaylarla keşfedilmeye devam ediyor!");
        }
    }
}
